  ...
  describe '#perform' do
    ...
    context 'when there is an Audio with the passed filename' do
      ...
      it 'updates the audio with the new information' do
        ...
        allow(File).to receive(:open).with('flac_path')
                                     .and_return('flac_content')
        allow(File).to receive(:open).with('he_aac_path')
                                     .and_return('he_aac_content')
    ...
    context 'when an exception raises' do
      ...
      it 'broadcast a failed message to FilesChannel with exception
        information' do
