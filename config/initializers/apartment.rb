...
# Require whichever Elevator you're using below or none if you have a custom
# one.
#
...
Apartment.configure do |config|
  ...
  # You can make this dynamic by providing a Proc object to be called on
  # migrations.
  ...
  # Uncomment the line below if you want to disable this behaviour in
  # production.
  #
